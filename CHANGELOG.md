...
### Added
- Compatibility with Minecraft 1.20.5
...
- Refactored render methods (vertex, bufferBuilder, Tessellator) into QuadBuffer class (for override ability in later Minecraft versions)
