...
public class Randomizer {
    ...
    private static List<String> errorResponseMessages = Arrays.asList(
            "Seems like my words got lost in the End. Check out https://elefant.gg/discord for clues!",
            "Oops! My speech bubble popped. Need help? Visit https://elefant.gg/discord",
            "I might've eaten a bad Command Block. Help me out at https://elefant.gg/discord!",
            "My words are on strike. More info? https://elefant.gg/discord",
            "I think a Creeper blew up my script. Instructions? https://elefant.gg/discord",
            "BRB, asking a villager for directions to https://elefant.gg/discord",
            "It’s not you, it’s my API key. Let's regroup at https://elefant.gg/discord",
            "I tried to speak, but it was a critical miss. Help at https://elefant.gg/discord",
            "Words are hard. Come chat at https://elefant.gg/discord",
            "I must've left my responses in my other pants. See https://elefant.gg/discord",
            "Shh... I’m hiding from an invalid API key. Join the hunt at https://elefant.gg/discord",
            "I’d tell you, but then I’d have to respawn. Meet me at https://elefant.gg/discord",
            "Error 404: Response not found. Maybe it’s at https://elefant.gg/discord?",
            "I'm speechless, literally. Let's troubleshoot at https://elefant.gg/discord",
            "Looks like my connection got lost in the Nether. Can you help? https://elefant.gg/discord",
            "I forgot what I was saying, but https://elefant.gg/discord remembers.",
            "Are my words mining without a pickaxe? Dig up some help at https://elefant.gg/discord",
            "Sorry, my parrot ate the response. Teach it better at https://elefant.gg/discord",
            "My magic mirror says: 'Better answers found at https://elefant.gg/discord'",
            "This message is temporarily out of order. Order yours at https://elefant.gg/discord"
    );
