...
public class LeadParticleFactory implements ParticleFactory<LeadParticleEffect> {
    ...
    @Override
    public LeadParticleEffect createParticle(LeadParticleEffect effect, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
        double angle = effect.getAngle();
        return new LeadParticleEffect(world, x, y, z, 0, 0, 0, this.spriteProvider, angle);
    }
}
